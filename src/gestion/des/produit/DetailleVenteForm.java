...
void icon(){
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        try {
           ...
           String marchendise=jTextAreaMAR.getText();
           
            Impression imprim = new Impression( db.NomeLocal(),"",jTextFieldNOM_PRE.getText(), jTextFieldID.getText()+"x xxxxxxx", jTextFieldPrix.getText()+" DA", jTextFieldDATE.getText(),marchendise, jTextFieldCOmm.getText()+" DA",  " DA",jTextFieldPrix.getText()+" DA", db.Tel(),db.Addr() );
