...
public class Stock {
    ...
    public Stock(int N_prod, String designation, String categorie, String unite, String date_exp, int qte_totale, int qte_vente,  float prix_vent, float prix_unt , float prix_grant , String barcode) {
        this.N_prod = N_prod;
        ...
        this.prix_grant =  prix_grant ; 
        this.barcode = barcode ;
    }

    public Stock(int N_prod, String designation, int qte_totale, int qte_vente, int qte_reste,float prix_ven, float gain , float prix_grant , String barcode) {
        this.N_prod = N_prod;
        this.designation = designation;
        this.qte_totale = qte_totale;
        this.qte_vente = qte_vente;
